                ...
                <!-- Validation Errors -->
                    ...
                    <form method="POST" action="{{ route('update-producto', $producto->id) }}">
                        ...
                        <div>
                            ...
                            <select class="block mt-1 w-full rounded" name="categoria_id"  required autofocus>
                        ...
                        <div>
                            ...
                            <select class="block mt-1 w-full rounded" name="sucursal_id"  required autofocus>
                                @if($sucursal->count() > 0)
                                  @foreach($sucursal as $s)
                                   @if ($s->id == $producto->sucursal_id)
                        ...
                        <div>
                            ...
                            <x-input class="block mt-1 w-full" type="text" name="precio" value="{{ $producto->precio }}" required autofocus type="number" min="0" step="1" max='99999'/>
                        </div>

                        <!-- Estado -->
                        @if($level == 'administrador')
                        <div>
                            <x-label for="sucursal_id" :value="__('Estado')" />
                            <select class="block mt-1 w-full rounded" name="estado"  autofocus>
                            ...
                            <x-input class="block mt-1 w-full" type="text" name="comentarios" value="{{ $producto->comentarios }}" autofocus type="text" max='100'/>
                        </div>
                        @endif
